...
for dirnum,directory in enumerate(dirnames):
    ...
    for lsmfile in files1:
        ...
        IJ.run(Channel1, "Analyze Particles...", "size=300-Infinity pixel add exclude stack");
        ...
        Channel2 = Generate_segmented(imp1, 2, "MaxEntropy", 1)
        # # # # Generate ROIs by "Analyse Particles"
        ...
        Channel4 = Generate_segmented(imp1, 4, "Moments", 2)
        # # # # Generate ROIs by "Analyse Particles"
