...
datapath = "D:/Experiments/Ubq/Results" 
...
#g = sns.pointplot(x="Timepoint after LLOMe treatment", y="Foci per cell", hue="Channel", data=df5, dodge=False, capsize=.1 )
g = sns.swarmplot(x="Timepoint after LLOMe treatment", y="Foci per cell", hue="Channel", data=df5, dodge=False, size=6)
#g = sns.swarmplot(x="Timepoint after LLOMe treatment", y="Foci per cell", hue="Channel", data=df5, dodge=False, )
